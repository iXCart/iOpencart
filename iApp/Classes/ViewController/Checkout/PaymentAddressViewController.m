...
- (void)viewDidLoad
{
    ...
    self.title = AppLocalizedString(@"Billing Address");
...
- (void)showNextScene
{
    ...
    AppViewController * viewController = [ShippingAddressViewController create];
...
- (void)nextStep:(id)sender
{
    ...
    NSDictionary* params =[NSDictionary dictionaryWithObjectsAndKeys:
                           exist, CheckoutPaymentAddress_payment_address,
                           address_id, CheckoutPaymentAddress_address_id,
                           nil];
    //@step
    [[XCartDataManager sharedInstance] savePaymentAddress:params success:^(RKObjectRequestOperation *operation, RKMappingResult *mappingResult) {
...
- (void)loadData
{
    [[XCartDataManager  sharedInstance ]getPaymentAddress: ^(RKObjectRequestOperation *operation, RKMappingResult *mappingResult) {
